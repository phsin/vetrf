Диалог: 
{
	...
	Элементы: 
	{
		...
		BUTTON: 
		{
			...
			Высота: 13
			ПорядокОбхода: 4201
			Формула: "ЗапуститьПриложение(""https://redmine.kb99.pro/projects/vsd_1c/wiki/%D0%92%D0%A1%D0%94_%D0%A2%D1%80%D0%B0%D0%BD%D0%B7%D0%B0%D0%BA%D1%86%D0%B8%D1%8F"")"
			Слой: Шапка
		}
		COMBOBOX: СписокФирм
		{
