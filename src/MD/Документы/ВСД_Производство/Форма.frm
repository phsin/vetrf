Диалог: 
{
	...
	Табличная часть: 
	{
		...
		Колонки: 
		{
			...
			BMASKED: Продукция_Элемент
			{
				...
				Ширина: 185
				ПорядокОбхода: 4155
				Формула: "ПриВыбореПродукция_Элемент()"
				Param15: 2
	...
	Элементы: 
	{
		...
		BUTTON: 
		{
			...
			Высота: 13
			ПорядокОбхода: 4200
			Формула: "ЗапуститьПриложение(""https://redmine.kb99.pro/projects/vsd_1c/wiki/%D0%92%D0%A1%D0%94_%D0%9F%D1%80%D0%BE%D0%B8%D0%B7%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%BE"")"
			Слой: Шапка
		}
		1CGROUPBOX: 
		{
