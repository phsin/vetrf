Диалог: 
{
	...
	Элементы: 
	{
		...
		1CEDIT: ДатаСрокГодностиСтрока
		{
			...
			ИдентификаторМетаданных: Документ.ВСД_входящаяПартия.ДатаСрокГодностиСтрока
			Тип: Строка
			Длина: 99
			ДопФлаги: Flag23, Flag28, Flag30
			X: 313
		...
		1CEDIT: ДатаИзготовленияСтрока
		{
			...
			ИдентификаторМетаданных: Документ.ВСД_входящаяПартия.ДатаИзготовленияСтрока
			Тип: Строка
			Длина: 99
			ДопФлаги: Flag23, Flag28, Flag30
			X: 94
		...
		BMASKED: ЕдиницаИзмерения
		{
			...
			ИдентификаторМетаданных: Документ.ВСД_входящаяПартия.ЕдиницаИзмерения
			Тип: Справочник
		...
		{
			Заголовок: "бумажный"
			ИдентификаторМетаданных: Документ.ВСД_входящаяПартия.ВидВСД
			Тип: Число
			Длина: 1
			ДопФлаги: Flag0, КартинкаПоЦентру, ПервыйВГруппе, Flag28, Flag30
			X: 410
		...
		BMASKED: ДатаИзготовления1
		{
			...
			ИдентификаторМетаданных: Документ.ВСД_входящаяПартия.ДатаИзготовления1
			Тип: Дата
			ДопФлаги: Flag23, Flag28, Flag30
			X: 42
			Y: 212
		...
		BMASKED: ДатаИзготовления2
		{
			...
			ИдентификаторМетаданных: Документ.ВСД_входящаяПартия.ДатаИзготовления2
			Тип: Дата
			ДопФлаги: Flag23, Flag28, Flag30
			X: 148
			Y: 212
		...
		BMASKED: ДатаСрокГодности1
		{
			...
			ИдентификаторМетаданных: Документ.ВСД_входящаяПартия.ДатаСрокГодности1
			Тип: Дата
			ДопФлаги: Flag23, Flag28, Flag30
			X: 259
			Y: 212
		...
		BMASKED: ДатаСрокГодности2
		{
			...
			ИдентификаторМетаданных: Документ.ВСД_входящаяПартия.ДатаСрокГодности2
			Тип: Дата
			ДопФлаги: Flag23, Flag28, Flag30
			X: 367
			Y: 212
		...
		CHECKBOX: Скоропортящийся
		{
			...
			ИдентификаторМетаданных: Документ.ВСД_входящаяПартия.Скоропортящийся
			Тип: Число
			Длина: 1
		...
		CHECKBOX: Некачественный
		{
			...
			ИдентификаторМетаданных: Документ.ВСД_входящаяПартия.Некачественный
			Тип: Число
			Длина: 1
			ДопФлаги: Flag0, Flag1, Flag28, Flag30
			X: 270
