Диалог: 
{
	...
	Табличная часть: 
	{
		...
		Колонки: 
		{
			...
			STATIC: Остаток
			{
				...
				Ширина: 70
				ПорядокОбхода: 4155
				Формула: "глФРМКоличество( ГМ.ПолучитьОстатокПартии( ТекущийЭлемент() ) )"
				Param15: 2
				Выравнивание: 1
	...
	Элементы: 
	{
		...
		BUTTON: кнЗагрузитьПартии
		{
			Заголовок: "Загрузить актуальные партии"
			ИдентификаторМетаданных: -1
			ДопФлаги: Flag0, Flag1, КартинкаПоЦентру, Flag28, Flag30
			X: 66
			Y: 292
