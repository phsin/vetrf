Диалог: 
{
	...
	Элементы: 
	{
		...
		{
			Заголовок: "Сортировать указанную колонку по убыванию"
			ИдентификаторМетаданных: -1
			Тип: Число
			Длина: 1
			ДопФлаги: Flag0, Flag1, Flag28, Flag30
